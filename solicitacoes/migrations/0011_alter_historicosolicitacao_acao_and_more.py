# Generated by Django 6.1 on 2026-08-30 03:51

from django.db import migrations, models

# A view do Power BI traduz os códigos de status: só o CASE muda (mesmas
# colunas), então CREATE OR REPLACE basta e o GRANT existente é preservado.
SQL_STATUS_DEVOLVIDA = """
...
def atualizar_view(apps, schema_editor):
    if schema_editor.connection.vendor != "postgresql":
        return
    schema_editor.execute(SQL_STATUS_DEVOLVIDA)


class Migration(migrations.Migration):

    dependencies = [
        ('solicitacoes', '0010_simplifica_views_powerbi'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='acao',
            field=models.CharField(choices=[('CRIACAO', 'Rascunho criado'), ('ATUALIZACAO', 'Solicitação atualizada'), ('ENVIO', 'Solicitação enviada'), ('INICIO_ANALISE', 'Análise iniciada'), ('PLANEJAMENTO', 'Planejamento atualizado'), ('ENCAMINHAMENTO_DESPACHO', 'Encaminhada para despacho'), ('DEVOLUCAO', 'Devolvida para ajuste'), ('DECISAO', 'Decisão da DG registrada')], max_length=30, verbose_name='ação'),
        ),
        migrations.AlterField(
            model_name='solicitacaoevento',
            name='status',
            field=models.CharField(choices=[('RASCUNHO', 'Rascunho'), ('AGUARDANDO_DESPACHO', 'Aguardando despacho'), ('DEVOLVIDA', 'Devolvida para ajuste'), ('ATENDIDA', 'Atendida'), ('NAO_ATENDIDA', 'Não atendida'), ('CANCELADA', 'Cancelada')], default='RASCUNHO', max_length=25, verbose_name='status'),
        ),
        # Sem status DEVOLVIDA no banco, voltar ao rótulo antigo é inócuo.
