...
CI passa na `main` (e à mão, em Actions › "Deploy VPS" › Run workflow). O
script vai do repositório pela conexão, então a cópia do VPS não precisa estar
em dia. Configuração da chave e dos secrets: `docs/DEPLOY_AUTOMATICO.md`.
