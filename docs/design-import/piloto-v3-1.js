/* V3.1 — Solicitações de Eventos Sociais (lista) · desktop, estado com dados
...
function render(){
  ...
  <div class="cabeca">
    <div class="cabeca__esq">
      <div class="contexto"><span>Eventos Sociais</span></div>
      <h1>Solicitações</h1>
      <div class="resumo">
        <button class="resumo__i" data-fila=""><b>186</b><span>solicitações</span></button>
        <span class="resumo__p" aria-hidden="true"></span>
        <button class="resumo__i resumo__i--aten" data-fila="despacho"><b>14</b><span>aguardando despacho</span></button>
        <span class="resumo__p" aria-hidden="true"></span>
        <button class="resumo__i" data-fila="devolvidas"><b>5</b><span>devolvidas para ajuste</span></button>
      </div>
    </div>
