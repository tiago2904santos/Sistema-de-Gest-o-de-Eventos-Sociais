...
class JustificativasListaTests(Cenario):
    ...
    def test_lista_mostra_regra_texto_e_acoes_numa_celula(self):
        ...
        r = self.url()
        self.assertContains(r, f"Ofício Nº {exigido.numero_formatado} · Protocolo 12.345.678-9")
        self.assertContains(r, "Exigida · 3 dias de antecedência (mínimo 10)")
        ...
        self.assertContains(r, "Sem modelo")
    ...
    def test_cancelado_fica_de_fora(self):
        ...
        self.assertNotContains(self.url(), f"Nº {cancelado.numero_formatado}")
