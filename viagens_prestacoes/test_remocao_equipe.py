...
class CamposConhecidosDoServidorDaPrestacaoTests(TestCase):
    ...
    ESPERADOS = {'id', 'prestacao', 'servidor', 'numero_solicitacao', 'diaria_valor_override', 'diaria_valor_override_observacao', 'data_liberacao_diarias', 'prazo_limite_saque', 'status', 'arquivada', 'arquivada_em', 'finalizada', 'finalizada_em', 'justificativa_finalizacao', 'enviada_em', 'protocolo_envio', 'decidida_em', 'motivo_devolucao', 'ajuste_pacote', 'removida_em', 'criado_em', 'atualizado_em', 'legado_origem', 'legado_pk'}
