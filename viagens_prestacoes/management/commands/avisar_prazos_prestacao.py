...
Cada aviso sai uma vez só; rodar de novo no mesmo dia não repete nada.
"""
...
class Command(BaseCommand):
    help = "Avisa no sino os prazos de saque e de prestação e os documentos gerados/assinados."
