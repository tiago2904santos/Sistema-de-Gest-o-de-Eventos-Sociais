    ...
    def test_abas_sao_mutuamente_exclusivas_e_mostram_contagens_exatas(self):
        ...
        for aba, ps_pk in casos.items():
            with self.subTest(aba=aba):
                ...
                self.assertEqual({item['value']: item['label'] for item in response.context['situacao_options']}, {'nao_liberadas': 'Não liberadas (1)', 'liberadas': 'Liberadas (1)', 'arquivados': 'Arquivados (1)', 'finalizados': 'Finalizados (1)'})
